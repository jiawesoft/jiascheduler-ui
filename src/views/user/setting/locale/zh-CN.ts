export default {
  ...
  'userSetting.label.accountStatus': '账号状态',
  ...
  'userSetting.basicInfo.placeholder.email': `请输入邮箱地址，如xxx{'@'}jiascheduler.com`,
  ...
  'userSetting.basicInfo.form.updateSuccess': '信息更新成功',
