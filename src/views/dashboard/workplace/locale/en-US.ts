export default {
  ...
  'workplace.pecs': 'pecs',
  'workplace.jobList': 'Job List',
  'workplace.server': 'Server',
  'workplace.jobBundle': 'Job Bundle',
  'workplace.runList': 'Run List',
  'workplace.execHistory': 'Exec History',
  'workplace.jobTotal': 'Job',
  'workplace.runTotal': 'Running',
  'workplace.successTotal': 'Success',
  'workplace.failedTotal': 'Failed',
  'workplace.successText': 'Success',
  'workplace.failedText': 'Failed',
  'workplace.passed': 'Passed',
  'workplace.notPassed': 'Did Not Pass',
  'workplace.lastStarTime': 'Last execute:',
  'workplace.checkResult': 'Check result',
};
