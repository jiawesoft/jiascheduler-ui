export default {
  ...
  'workplace.runTotal': '正在运行',
  'workplace.successTotal': '执行成功',
  'workplace.failedTotal': '执行失败',
  'workplace.successText': '成功',
  'workplace.failedText': '失败',
  'workplace.passed': '通过',
  'workplace.notPassed': '不通过',
  'workplace.lastStarTime': '最近执行：',
  'workplace.checkResult': '校验结果',
};
