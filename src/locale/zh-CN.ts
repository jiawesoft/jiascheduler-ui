...
const localeJob = {
  ...
  'job.arg.updateNeedSave': '参数更新需要保存后才生效',
...
const localeInstance = {
  ...
  'instance.sshUser.title': 'SSH 登录用户',
  'instance.sshUser.tip':
    '可配置多个 SSH 登录用户，支持密码或密钥认证，并选择其中一个作为默认登录用户',
  'instance.sshUser.default': '默认',
  'instance.sshUser.add': '添加登录用户',
  'instance.sshUser.username.placeholder': '登录用户名',
  'instance.sshUser.password.placeholder': '密码，留空表示不修改',
  'instance.sshUser.keyPath.placeholder':
    '密钥文件路径，如 /home/user/.ssh/id_rsa',
  'instance.sshUser.keyContent.placeholder': '密钥内容，留空表示不修改',
  'instance.sshUser.importKeyFile': '导入密钥文件',
  'instance.sshUser.importKeyFileSuccess': '已导入密钥文件 {name}',
  'instance.sshUser.fileTooLarge': '文件过大，最大支持读取 {max}',
  'instance.sshUser.storedPlaceholder': '已设置，点击修改',
  'instance.sshUser.inputPlaceholder': '未设置，点击输入',
  'instance.sshUser.resetField': '清空并收起',
  'instance.sshUser.usernameRequired': '请填写登录用户名',
  'instance.sshUser.passwordRequired': '请填写登录密码',
  'instance.sshUser.keyPathRequired': '请填写密钥文件路径',
  'instance.sshUser.keyContentRequired': '请填写密钥内容',
  'instance.sshUser.more': '等 {count} 个',
  'instance.sshUser.agentTip': 'agent 上报：{user}',
